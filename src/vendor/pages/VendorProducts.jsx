...
const EMPTY_FORM = {
    ...
    image: "", badge: "", inStock: true, featured: false,
}
...
function VendorProducts() {
    ...
    async function loadProducts() {
        try {
            setLoading(true)
            setError(null)
            const data = await fetchVendorProducts(getToken())
            setProducts(data)
        } catch (err) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (editId) {
                await updateVendorProduct(editId, payload, getToken())
                showToast("Product updated! ✅", "success")
            } else {
                await createVendorProduct(payload, getToken())
    ...
    async function handleDelete(id) {
        ...
        try {
            await deleteVendorProduct(id, getToken())
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            {products.length === 0 ? (
                <div className="bg-white rounded-2xl p-12 text-center border border-gray-100 flex flex-col items-center gap-4">
                    <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center">
                        <Plus size={28} className="text-gray-400" />
                    </div>
                    <h3 className="font-bold text-gray-700">No products yet</h3>
                    <p className="text-gray-400 text-sm">Add your first product to start selling on Vendly.</p>
                    <button
                        onClick={openCreate}
            ...
            {showForm && (
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl w-full max-w-lg max-h-screen overflow-y-auto shadow-2xl">
