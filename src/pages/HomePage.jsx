        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex-1 flex flex-col gap-5">
            ...
            <div className="flex gap-3 flex-wrap">
              <Link to="/products" className="flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-full font-semibold hover:opacity-90 transition">
                Shop Now <ArrowRight size={18} />
              </Link>
              <Link to="/vendors" className="flex items-center gap-2 border border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-dark transition">
                Browse Vendors
              </Link>
            </div>
          </div>
          ...
          <div className="flex-1 flex justify-center md:justify-end">
            <div className="bg-white text-dark rounded-3xl p-8 flex flex-col gap-5 w-full max-w-sm shadow-2xl">
              <h3 className="font-bold text-lg text-gray-800">Why ShopHub?</h3>
              {[
